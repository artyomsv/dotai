...
- Reference issues with `Ref #42` — never a closing keyword (`Closes`, `Fixes`,
  `Resolves`), and never the pull request sidebar **Development** panel. A merged pull
  request is not finished work; a human closes the issue after testing.
